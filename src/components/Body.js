...
filteredRestaurant.map((restaurant) => (<Link key={restaurant.data?.id} to={`/restaurants/${restaurant.data?.id}`} className="link-style">< RestaurantCard  resData={restaurant.data}/></Link>))
